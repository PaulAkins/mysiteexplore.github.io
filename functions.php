...
function vw_ecommerce_store_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'vw-ecommerce-store') {
		wp_redirect(admin_url('themes.php?page=vw_ecommerce_store_guide'));
	}
}
endif;
