<?php
	...
	if($vw_ecommerce_store_theme_lay == 'fixed'){
		$vw_ecommerce_store_custom_css .='#footer{';
			$vw_ecommerce_store_custom_css .='background-attachment: fixed !important; background-position: center !important;';
		$vw_ecommerce_store_custom_css .='}';
	}elseif ($vw_ecommerce_store_theme_lay == 'scroll'){
		$vw_ecommerce_store_custom_css .='#footer{';
			$vw_ecommerce_store_custom_css .='background-attachment: scroll !important; background-position: center !important;';
		$vw_ecommerce_store_custom_css .='}';
	}
