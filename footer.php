...
?>
    <footer role="contentinfo">
        <?php if (get_theme_mod('vw_ecommerce_store_footer_hide_show', true)){ ?>
        ...
        <?php }?>
        <?php if (get_theme_mod('vw_ecommerce_store_copyright_hide_show', true)) {?>
            <div id="footer-2">
              	<div class="copyright container">
                    ...
                    <?php if(get_theme_mod('vw_ecommerce_store_footer_icon',false) != false) {?>
                        <?php dynamic_sidebar('footer-icon'); ?>
                    <?php }?> 
                    <?php if( get_theme_mod( 'vw_ecommerce_store_hide_show_scroll',true) == 1 || get_theme_mod( 'vw_ecommerce_store_resp_scroll_top_hide_show',true) == 1) { ?>
